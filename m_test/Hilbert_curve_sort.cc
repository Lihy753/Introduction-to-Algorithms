...
int normalize(double val, double min_val, double max_val, int grid_size) {
    ...
    return static_cast<int>(ratio * (grid_size - 1));
}
...
int main() {
    ...
    Non_conflict_polygons* poly5 = new Non_conflict_polygons(4, 2, 2, 1);
